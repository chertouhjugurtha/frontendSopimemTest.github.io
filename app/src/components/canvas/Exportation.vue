    ...
    <div class="stepsdemo-content">
        <Card>
            <template v-slot:title>
                Informations sur le produit d'exportation
            </template>
            ...
            <template v-slot:content>
                <DataTable :value="classes" editMode="row" dataKey="Dénomination" v-model:editingRows="editingRows"
                    ...
                    <Column field="Dénomination" header="Dénomination" style="width:20%">
            ...
            <div class="formgrid grid">
                <div class="field col">
                                <span class="p-float-label">
                                    <InputText id="name" v-model="newSite.Dénomination" />
                ...
                <div class="field col">
                                ...
                                <span class="p-float-label">
                                    <InputText id="prenom" v-model="newSite.Abréviation" />
                                    <label for="prenom">Abréviation</label>
                                </span>
                </div>
                <div class="field col">

                                <span class="p-float-label">
                                    <InputText id="prenom" v-model="newSite.siègeSocial" />
                                    <label for="prenom">Adresse du siège social</label>
                                </span>
                </div>
            ...
            <div class="formgrid grid" >
                 ...
                 <div class="field col-12 md:col-4" style="padding-top: 10px;">
                    <span class="p-float-label">
                        ...
                        <label for="dropdown">Secteur d'Activite</label>
                    </span>
                </div>
                <div class="field col-12 md:col-4" style="padding-top: 10px;">
                    <span class="p-float-label">
    ...
    setup(_, { emit }) {
        ...
        function tableData() {
            columns.value = [
                ...
                { field: 'Abréviation', header: 'Abréviation' },
